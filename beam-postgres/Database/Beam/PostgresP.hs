...
module Database.Beam.PostgresP
  (  -- * Beam Postgres backend
    PostgresP(..), Pg, liftIOWithHandle
...
import Database.Beam.Postgres.ConnectionP
import Database.Beam.Postgres.FullP () -- for BeamHasInsertOnConflict instance
